...
{
    public partial class EditProductosinst
    {
        [Inject]
        ...
        {
            productosinst = await DB_157005_crm7desService.GetProductosinstByIdProducto(ID_PRODUCTO);
        ...
        protected async Task FormSubmit()
        {
            try
            {
                await DB_157005_crm7desService.UpdateProductosinst(ID_PRODUCTO, productosinst);
