...
namespace QCRM.Pages
{
    public partial class ApplicationUsers
    {
        ...
        protected IEnumerable<QCRM.Models.ApplicationUser> users;
        protected RadzenDataGrid<QCRM.Models.ApplicationUser> grid0;
        ...
        protected async Task RowSelect(QCRM.Models.ApplicationUser user)
        {
        ...
        protected async Task DeleteClick(QCRM.Models.ApplicationUser user)
        {
            try
            {
