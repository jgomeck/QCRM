...
{
    public partial class EditProyectos
    {
        [Inject]
        ...
        {
            proyectos = await DB_157005_crm7desService.GetProyectosByProyecto(PROYECTO);
        ...
        protected async Task FormSubmit()
        {
            try
            {
                await DB_157005_crm7desService.UpdateProyectos(PROYECTO, proyectos);
