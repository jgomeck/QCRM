...
{
    public partial class EditOportunidades
    {
        [Inject]
        ...
        {
            oportunidades = await DB_157005_crm7desService.GetOportunidadesByIdOportunidad(ID_OPORTUNIDAD);
        ...
        protected async Task FormSubmit()
        {
            try
            {
                await DB_157005_crm7desService.UpdateOportunidades(ID_OPORTUNIDAD, oportunidades);
