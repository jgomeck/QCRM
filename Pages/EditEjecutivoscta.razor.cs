...
{
    public partial class EditEjecutivoscta
    {
        [Inject]
        ...
        {
            ejecutivoscta = await DB_157005_crm7desService.GetEjecutivosctaByIdEjecutivoCuenta(ID_EJECUTIVO_CUENTA);
        ...
        protected async Task FormSubmit()
        {
            try
            {
                await DB_157005_crm7desService.UpdateEjecutivoscta(ID_EJECUTIVO_CUENTA, ejecutivoscta);
