...
{
    public partial class EditActividades
    {
        [Inject]
        ...
        {
            actividades = await DB_157005_crm7desService.GetActividadesByIdActividad(ID_ACTIVIDAD);
        ...
        protected async Task FormSubmit()
        {
            try
            {
                await DB_157005_crm7desService.UpdateActividades(ID_ACTIVIDAD, actividades);
